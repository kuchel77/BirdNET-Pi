...
if(isset($_GET['view'])){
  ...
  if (!isset($_SERVER['PHP_AUTH_USER'])) {
    ...
    $allowedCommands = array('sudo systemctl stop livestream.service && sudo /etc/init.d/icecast2 stop',
                       ...
                       'sudo systemctl stop birdnet_api.service',
                       'sudo systemctl restart birdnet_api.service',
                       'sudo systemctl disable --now birdnet_api.service',
                       'sudo systemctl enable --now birdnet_api.service',
